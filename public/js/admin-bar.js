/**
 * NOTE: Copy of wp-includes/js/admin-bar.js but with a callback to have possibility to initialize Admin bar dynamically.
 */
/**
...
( function( document, window, navigator ) {
    window.innocodeJSONBarInit = function() {
    ...
    document.addEventListener( 'DOMContentLoaded', window.innocodeJSONBarInit );
